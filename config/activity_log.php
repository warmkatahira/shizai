...
return [
    ...
    'routes' => [
        ...
        'admin.units.store' => ['action' => 'master.unit_created', 'label' => '単位の登録', 'category' => 'master', 'default' => true],
        'admin.units.update' => ['action' => 'master.unit_updated', 'label' => '単位の更新', 'category' => 'master', 'default' => true],
        'admin.units.destroy' => ['action' => 'master.unit_deleted', 'label' => '単位の削除', 'category' => 'master', 'default' => true],
