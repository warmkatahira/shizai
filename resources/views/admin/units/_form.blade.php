<div class="space-y-4">
    <div>
        <label for="name" class="block text-sm font-medium text-gray-700 mb-1">単位名 <span class="text-red-500">*</span></label>
        <input autocomplete="off" id="name" name="name" type="text" value="{{ old('name', $unit->name) }}" required
        ...
        <p class="text-xs text-gray-400 mt-1">例：枚, ケース, 本, 個, 巻</p>
    </div>
    ...
    <div class="flex items-center gap-3 pt-2">
        ...
        <a href="{{ route('admin.units.index') }}" class="text-sm text-gray-500 hover:underline">キャンセル</a>
    </div>
</div>
